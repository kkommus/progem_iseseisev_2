            ...
            <div class="row">
                <div class="col-md-12 text-end">
                    <p><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        ...
                        </svg> sinu@nimi.ee <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                        ...
                        </svg> +372 5555 6666 | <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
    ...
    <div class="container mt-5">
        ...
        <form action="" method="GET">
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control" id="input_value1" name="input_value1" required min="200"
                    required max="1000" step="50">
            </div>
            <br>
